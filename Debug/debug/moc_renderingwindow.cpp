...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RenderingWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 16, 11), // "timeOutSlot"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "RenderingWindow\0timeOutSlot\0"
};
...
void RenderingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RenderingWindow *_t = static_cast<RenderingWindow *>(_o);
        switch (_id) {
...
const QMetaObject RenderingWindow::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_RenderingWindow.data,
      qt_meta_data_RenderingWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RenderingWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RenderingWindow.stringdata))
