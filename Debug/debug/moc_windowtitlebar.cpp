...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WindowTitleBar_t, stringdata) + ofs \
...
const QMetaObject WindowTitleBar::staticMetaObject = {
    { &QMenuBar::staticMetaObject, qt_meta_stringdata_WindowTitleBar.data,
      qt_meta_data_WindowTitleBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WindowTitleBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WindowTitleBar.stringdata))
