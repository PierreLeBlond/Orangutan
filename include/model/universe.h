...
public:
  ...
  [[nodiscard]] const Library<RenderableObject> &
  get_renderable_object_library() const;
  ...
  [[nodiscard]] const Library<ShaderWrapper> &
  get_shader_wrapper_library() const;
  ...
  RenderableObject *
  AddRenderableObject(std::unique_ptr<RenderableObject> renderable_object);
  ...
  ShaderWrapper *
  AddShaderWrapper(std::unique_ptr<ShaderWrapper> shader_wrapper);
