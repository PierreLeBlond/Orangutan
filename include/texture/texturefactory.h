...
public:
  ...
  ImportCubeTexture(const std::string &name, const std::string &filename);
  ...
  static std::unique_ptr<Ibl> ImportIBLFromHdr(const std::string &name,
                                               const std::string &filename);
  static std::unique_ptr<Ibl>
  ImportIBLFromDds(const std::string &name,
...
private:
  ...
  static std::unique_ptr<CubeTexture>
  CreateRadianceMap(const CubeTexture &cube_texture);
  static std::unique_ptr<CubeTexture>
  ImportCubeTextureFromDds(const std::string &name,
                           const std::string &filename);
  static std::unique_ptr<CubeTexture>
  ImportCubeTextureFromRgbdDds(const std::string &name,
                               const std::string &filename);
};
