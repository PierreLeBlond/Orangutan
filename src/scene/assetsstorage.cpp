...
const std::vector<std::shared_ptr<ShaderProgram>>& AssetsStorage::getShaderPrograms() const{
...
std::shared_ptr<ShaderProgram> AssetsStorage::getShaderProgram(int index) const{
...
void AssetsStorage::addShaderProgram(std::shared_ptr<ShaderProgram> shaderProgram){
