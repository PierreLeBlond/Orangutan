...
const std::unordered_map<std::string, Uniform<int>> &
Material::get_uniforms_1i() const {
  return uniforms_1i_;
}
...
const std::unordered_map<std::string, const Texture *> &
Material::get_textures() const {
  return textures_;
}
