...
const Library<RenderableObject> &
Universe::get_renderable_object_library() const {
...
CubeTexture *
Universe::AddCubeTexture(std::unique_ptr<CubeTexture> cube_texture) {
...
ShaderWrapper *
Universe::AddShaderWrapper(std::unique_ptr<ShaderWrapper> shader_wrapper) {
